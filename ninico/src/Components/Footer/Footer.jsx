            ...
            <footer className='mt-10 pb-7 pt-16 px-28    bg-footer text-footer-3 ' >
                <div className="flex justify-between">
                    <div className="w-64">
                        <img src={Logo} alt="" />
                        <div className="mt-5  ">
                            Elegant pink origami design three dimensional view and decoration co-exist. Great for
                    ...
                    <ul className='w-64'>
                        <li className='font-bold text-black '><a href="">Get NewSletter</a></li>
                        <li>Get on the list and get 10% off your first order!</li>
                        <li> <input type="text" name="" className='w-60 h-14 p-4' placeholder='Enter amail address' id="" /> </li>
                        <li className='mt-4 bg-ninico  flex justify-center items-center w-48  py-4 px-7 rounded-md text-white font-medium text-sm'> <button className='flex'>Subscribe Now <img src={ArrowRight} className='ms-3' width={20} alt="" /> </button> </li>
                    </ul>
                </div>
                ...
                <div className="flex justify-between">
                    <div className=" px-3  flex ">
                        <div className="bg-red-300 w-12  flex justify-center items-center rounded-full">
                    ...
                    <div className="flex items-center ">
                        <div className="">
                            <div className="font-bold underline-offset-2 text-black ">Download App on Mobile</div>
                    ...
                    <div className="">
                        Copyright 2024 &#169; 
                            <span className='font-bold'>Ninico.</span>
                             &nbsp; All rights reserved. Developed by <span className='font-bold'>AliThemes.</span>  
                    </div>
                    <div className="">
